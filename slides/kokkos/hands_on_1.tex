...
\begin{frame}
  ...
  \item In your home on \texttt{ouessant}: 
    ...
    \item \texttt{module load at/11.0 cuda/9.2}
    \item \texttt{make}
...
\begin{frame}[fragile=singleslide]
  ...
  \item \textbf{Serial build (default, with hwloc):}\\
    ...
    \end{itemize}
  \item environment:~\footnote{module at/11.0 provides gnu (advanced) toolchain, version 7.2.1} \texttt{module load at/11.0 cuda/9.2}
