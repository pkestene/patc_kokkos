...
\begin{frame}
  ...
  \begin{itemize}
  \item {\bf \textcolor{violet}{Current Kokkos training material}}
    \begin{itemize}
    \item last up-to-date archive is on \texttt{ouessant}:\\
    ...
    \end{itemize}
  \item {\bf \textcolor{violet}{Official documentation}}
    \begin{itemize}
    \item Wiki on github : \myurl{https://github.com/kokkos/kokkos/wiki}
    \item Kokkos programming guide in sources : \myurl{https://github.com/kokkos/kokkos/blob/master/doc/Kokkos_PG.pdf}
    \end{itemize}
  \end{itemize}
