...
\begin{frame}
  ...
  \item \textcolor{red}{Multiple execution / memory space} can be used in a single application\\
    ...
    Though, take care that currently, Cuda stream are not completely mapped into Kokkos API~\footnote{To be implemented.}; meanwhile Cuda streams can be used directly (but looses some portability);~\footnote{\myhref{https://github.com/kokkos/kokkos/issues/1723}{kokkos/issues/1723}} 
  \end{itemize}
