...
\begin{frame}
  ...
  \begin{itemize}
  \item \fbox{\bf Very large combinatorics of compile options / compiler / target architecture !}
...
\begin{frame}[fragile=singleslide]
   ...
   \item \textcolor{blue}{\textbf{Build/install Kokkos with spack:}}
      ...
      \item see \myhref{https://github.com/kokkos/kokkos/blob/master/Spack.md}{kokkos+spack}
...
\begin{frame}[fragile=singleslide]
  ...
  \item \textcolor{red}{\textbf{What's happening inside \texttt{Kokkos::initialize}}}
    ...
    \item Defines \textcolor{blue}{\texttt{Default Device / DefaultExecutionSpace Default memory space}} as specified when kokkos itself was built, by order of {\bf priority}:\\
      ...
      see header \myhref{https://github.com/kokkos/kokkos/blob/master/core/src/Kokkos_Macros.hpp}{Kokkos\_Macros.hpp}
