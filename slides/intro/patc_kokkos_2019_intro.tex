...
\title{\large Introduction to performance portability. Mini-overview of Kokkos/C++ library.}

\author
{
  \textcolor{purple}{\underline{\href{https://github.com/pkestene}{Pierre Kestener}}}\inst{1}
  %\mbox{\underline{\href{https://github.com/pkestene}{Pierre Kestener}}}\inst{1}
}
...
\input{recommended_links}
\input{other_interesting_things}
