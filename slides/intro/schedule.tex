...
\begin{frame}
  ...
  \item \texttt{ouessant} : a CPU (IBM Power8) + GPU (Nvidia Pascal P100) computing platform : short overview % ~ 30 minutes
...
\begin{frame}
  ...
  \myurl{/pwrwork/workshops/2019-04_patc} on \texttt{ouessant}}
