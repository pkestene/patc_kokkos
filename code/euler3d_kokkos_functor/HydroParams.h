...
struct HydroParams {
  ...
  int nz=0;     /*!< logical size along Z (without ghost cells).*/
  int ghostWidth=2;  
  ...
  int kmin=0;   /*!< index minimum at Z border*/
  int kmax=0;   /*!< index maximum at Z border*/
  ...
  int ksize=0;  /*!< total size (in cell unit) along Z direction with ghosts.*/
  ...
  int boundary_type_zmin=1;
  int boundary_type_zmax=1;
  ...
  HydroParams() :
    ...
    isize(0), jsize(0), ksize(0), ijsize(0), ijksize(0),
